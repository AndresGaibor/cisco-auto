...
export const PUBLIC_COMMAND_DEFINITIONS: PtCommandDefinition[] = [
  ...
  },
  {
    ...
    description: "Comando universal de terminal. Detecta si el dispositivo es IOS o host y usa el backend correcto. Comandos de configuración se detectan automáticamente (no necesitas --config).",
    examples: [
