/**
 * Base de comandos relacionados para la sección "See also"
 */
...
/**
 * Obtiene comandos relacionados para un comando específico
 */
...
/**
 * Obtiene comandos relacionados para un comando padre
 */
