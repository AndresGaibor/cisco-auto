#!/usr/bin/env bun
/**
 * Inicialización local del esquema SQLite para memoria.
 * Reemplaza la dependencia de @cisco-auto/core/memory/schema.
 */
 ...
 */
export function initializeLocalSchema(db: Database): void {
