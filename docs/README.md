...
### [**@cisco-auto/core**](../packages/core/docs/)
Orquestadores de despliegue, parsers de configuración IOS y el catálogo de hardware.
- [Validación de Dispositivos](../packages/core/docs/device-validation.md)
- [Módulos Avanzados](../packages/core/docs/advanced-modules.md)
