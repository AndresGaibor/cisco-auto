...
export class EtherChannelGenerator {
     ...
     */
    static getModeCommand(mode, protocol) {
        // LACP: active, passive
        // PAgP: desirable, auto
        // Static: on
        if (protocol === 'static') {
     ...
     */
    static validateCompatibility(channel1, channel2) {
        const issues = [];
        // Mismo protocolo
...
//# sourceMappingURL=etherchannel.generator.js.map