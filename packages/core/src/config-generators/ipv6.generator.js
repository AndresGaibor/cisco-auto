...
export class IPv6Generator {
     ...
     */
    static generateStaticRoute(route) {
        const commands = [];
    ...
    static isValidIPv6Prefix(prefix) {
...
//# sourceMappingURL=ipv6.generator.js.map