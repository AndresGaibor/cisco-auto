...
export class RoutingGenerator {
     ...
     */
    static isValidRouterId(routerId) {
        const ipv4Pattern = /^(\d{1,3}\.){3}\d{1,3}$/;
        if (!ipv4Pattern.test(routerId))
            return false;
    ...
    static generateRouting(routing) {
        const commands = [];
        if (!routing)
            return commands;
...
//# sourceMappingURL=routing-generator.js.map