export class SecurityGenerator {
     ...
     */
    static buildACLRule(rule, aclType) {
     ...
     */
    static generateSecurity(security) {
        const commands = [];
...
//# sourceMappingURL=security-generator.js.map