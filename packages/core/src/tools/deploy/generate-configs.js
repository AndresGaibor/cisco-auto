 ...
 */
function generateRouterConfig(device) {
    const lines = [];
    // Hostname
 ...
 */
function generateSwitchConfig(device) {
    const lines = [];
    // Hostname
    lines.push(`hostname ${device.name}`);
    lines.push('!');
 ...
 */
function generatePCConfig(device) {
    const lines = [];
 ...
 */
function generateServerConfig(device) {
    const lines = [];
 ...
 */
function iosToYaml(device, iosConfig) {
    const lines = [];
 ...
 */
function iosToJson(device, iosConfig) {
    const configObj = {
 ...
 */
function generateConfigs(plan, format) {
    const configs = [];
...
// TOOL DEFINITION
// =============================================================================
export const ptGenerateConfigsTool = {
