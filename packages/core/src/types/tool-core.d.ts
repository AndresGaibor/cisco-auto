...
export type ToolHandler<TInput extends ToolInput = ToolInput, TOutput = unknown> = (input: TInput, context: ToolExecutionContext) => Promise<ToolResult<TOutput>>;
...
export type ToolCategory = 'topology' | 'configuration' | 'validation' | 'execution' | 'deployment' | 'monitoring' | 'utility';
...
//# sourceMappingURL=tool-core.d.ts.map