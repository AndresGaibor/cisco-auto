...
export type NetworkType = 'single_lan' | 'multi_lan' | 'multi_lan_wan' | 'star' | 'hub_spoke' | 'router_on_a_stick' | 'triangle' | 'custom';
...
export type CableTypePlan = 'straight-through' | 'crossover' | 'fiber' | 'serial' | 'console' | 'auto';
...
export type ValidationErrorType = 'invalid_model' | 'invalid_port' | 'invalid_cable' | 'ip_conflict' | 'duplicate_name' | 'missing_ip' | 'invalid_subnet' | 'port_unavailable' | 'vlan_mismatch' | 'routing_conflict';
export interface ValidationWarning {
    type: ValidationWarningType;
    message: string;
    affected?: string;
}
export type ValidationWarningType = 'suboptimal_cable' | 'unused_port' | 'unused_vlan' | 'recommendation';
