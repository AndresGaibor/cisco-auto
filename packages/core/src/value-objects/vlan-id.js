...
export class VlanId {
    ...
    classifyVlan(value) {
        if (value === 1)
            return VlanType.DEFAULT;
        if (value >= 2 && value <= 1001)
            return VlanType.NORMAL;
        if (value >= 1002 && value <= 1005)
            return VlanType.RESERVED;
 ...
 */
export function parseOptionalVlanId(value) {
...
//# sourceMappingURL=vlan-id.js.map