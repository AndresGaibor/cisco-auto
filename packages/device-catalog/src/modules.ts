...
import type { ModuleDefinition, PortDefinition } from './schema';
 ...
 */
export function getModulesBySlotType(slotType: string): ModuleDefinition[] {
 ...
 */
export function getModuleTotalPorts(module: ModuleDefinition): number {
