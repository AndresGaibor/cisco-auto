// Stubs de tipos reubicados desde pt-runtime/src/pt-api/pt-results.ts
// pt-control no puede importar de pt-runtime

import type { DeferredJobPlan, SessionStateSnapshot } from "../plans/runtime-contracts.js";
