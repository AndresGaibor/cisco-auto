// packages/pt-mcp/src/tools/mcp-response-guidance.ts
// Lógica de guidance para respuestas MCP — suggestions, signals, instructivo builder
// Extraído de mcp-response.ts para reducir el tamaño del módulo principal.
...
export function uniqueLines(values: Array<string | undefined | null>): string[] {
...
// ─── inferencia de dispositivos y comandos ─────────────────────────────────

export function inferDeviceKind(entity: unknown): string | null {
...
export function inferCommandFamily(command: string): string {
...
export function commandSuggestionsForFamily(family: string, deviceKind?: string | null): string[] {
  switch (family) {
    case "vlan":
      return [
...
export function summarizeDeviceKinds(devices: unknown[]): { count: number; kinds: Record<string, number>; firstName?: string } {
...
export function buildSignalGuidance(payload: JsonRecord): Partial<InstructivoOptions> {
...
export function buildGuidanceFromAction(toolName: string, payload: JsonRecord): Partial<InstructivoOptions> {
...
export function mergeGuidance(base: InstructivoOptions, extra: Partial<InstructivoOptions>): InstructivoOptions {
  return {
    ...base,
...
export function formatearJSON(datos: Record<string, unknown>): string {
