...
- **Vía de acceso de muestra:** `devices[2]`
- **Total de métodos únicos:** 108
...
| `addPhoneConnection` | 0 | `function() { [native code] }` |
| `addPortConnection` | 0 | `function() { [native code] }` |
| `addProgrammingSerialOutputs` | 0 | `function() { [native code] }` |
| `addSound` | 0 | `function() { [native code] }` |
| `addSubLinkConnection` | 0 | `function() { [native code] }` |
...
| `getHardwareQueueAt` | 0 | `function() { [native code] }` |
| `getHardwareQueueCount` | 0 | `function() { [native code] }` |
...
| `getPortConnectionCount` | 0 | `function() { [native code] }` |
| `getPortCount` | 0 | `function() { [native code] }` |
| `getPorts` | 0 | `function() { [native code] }` |
| `getPortStrConnections` | 0 | `function() { [native code] }` |
...
| `getSubLinkConnectionAt` | 0 | `function() { [native code] }` |
| `getSubLinkConnectionCount` | 0 | `function() { [native code] }` |
| `getSubLinkConnectionInfo` | 0 | `function() { [native code] }` |
...
| `isDslConnection` | 0 | `function() { [native code] }` |
...
| `removeAllPortConnection` | 0 | `function() { [native code] }` |
| `removeCustomVar` | 0 | `function() { [native code] }` |
| `removeModule` | 0 | `function() { [native code] }` |
| `removePhoneConnection` | 0 | `function() { [native code] }` |
| `removePortConnection` | 0 | `function() { [native code] }` |
| `removeSubLinkConnection` | 0 | `function() { [native code] }` |
| `removeSubLinkConnectionAt` | 0 | `function() { [native code] }` |
...
| `setDslConnection` | 0 | `function() { [native code] }` |
