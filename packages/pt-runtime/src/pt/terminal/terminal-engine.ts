  ...
  function executeCommand(
    ...
    return new Promise((resolve, reject) => {
      ...
      function onEnded(src: unknown, args: unknown) {
        ...
        try { terminal.unregisterEvent("outputWritten", null, onOutput); } catch(e) {}
        try { terminal.unregisterEvent("commandEnded", null, onEnded); } catch(e) {}
      ...
      try { terminal.registerEvent("outputWritten", null, onOutput); } catch(e) {}
      try { terminal.registerEvent("commandEnded", null, onEnded); } catch(e) {}
