...
export const VERIFIED_MODELS = {
  ...
  switches: {
    ...
    '2960-24TT-L': { model: '2960-24TT-L', type: 1, verified: true },
    '2960-24TC-L': { model: '2960-24TC-L', type: 1, verified: true },
    '3560-24PS': { model: '3560-24PS', type: 16, verified: true },
    '3650-24PS': { model: '3650-24PS', type: 16, verified: true },
    'IE-2000': { model: 'IE-2000', type: 1, verified: true },
    'IE-3400': { model: 'IE-3400', type: 1, verified: true },
    'IE-9320': { model: 'IE-9320', type: 16, verified: true },
    'Bridge-PT': { model: 'Bridge-PT', type: 1, verified: true },
  } as const,
  wireless: {
