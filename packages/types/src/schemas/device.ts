import { z } from 'zod';
import { IPCidrSchema, IPAddressSchema, MACAddressSchema } from './common.js';
import { OSPFSchema, EIGRPSchema, VTPSchema } from './protocols.js';
import { ACLSchema, NATSchema } from './security.js';
...
export const DeviceSchema = z.object({
  ...
  model: z.string().optional().describe('Modelo del dispositivo (ej: Cisco 2911)'),
