...
export class AdvancedRoutingGenerator {
   ...
   */
  static validateRIP(spec: RIPSpec): { valid: boolean; errors: string[]; warnings: string[] } {
    const errors: string[] = [];
   ...
   */
  static validateBGP(spec: BGPSpec): { valid: boolean; errors: string[]; warnings: string[] } {
    const errors: string[] = [];
    const warnings: string[] = [];
