...
import type { Device, ACL, NAT } from '../../core/types/index.ts';
import type {
  BGPSpec,
  DHCPServerSpec,
  EtherChannelSpec,
  ...
  STPSpec,
  SyslogSpec,
} from '../../core/canonical/protocol.spec.ts';
import { BaseGenerator } from '../../core/config-generators/base-generator.ts';
import { VlanGenerator } from '../../core/config-generators/vlan-generator.ts';
import { STPGenerator } from '../../core/config-generators/stp.generator.ts';
import { EtherChannelGenerator } from '../../core/config-generators/etherchannel.generator.ts';
import { RoutingGenerator } from '../../core/config-generators/routing-generator.ts';
import { AdvancedRoutingGenerator } from '../../core/config-generators/advanced-routing.generator.ts';
import { SecurityGenerator } from '../../core/config-generators/security-generator.ts';
import { ServicesGenerator } from '../../core/config-generators/services.generator.ts';
import { IPv6Generator } from '../../core/config-generators/ipv6.generator.ts';
