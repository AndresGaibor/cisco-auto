import type { Tool, ToolInput, ToolResult, TopologyPlan, DevicePlan, LinkPlan, TopologyPlanParams } from '../../core/types/tool.ts';
import { deviceCatalog } from '../catalog/list-devices.ts';
